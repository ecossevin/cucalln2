...
#/home/gmap/mrpm/cossevine/cucalln2/compile.cpu_intel_d/main_cucalln_mf.x \
#  --case-out . \
#  --ngpblks 1 \
#  --case-in /scratch/work/cossevine/tmp/cucalln/000001 \
#  --verbose --diff --method openmp
/home/gmap/mrpm/cossevine/cucalln2/compile.cpu_intel_d/main_cucalln_mf.x \
  --case-out /scratch/work/cossevine/tmp/cucalln/out \
  --ngpblks 1 \
  --case-in /scratch/work/cossevine/tmp/cucalln/000001 \
  --verbose --method openmpsinglecolmun \
  --times 1
